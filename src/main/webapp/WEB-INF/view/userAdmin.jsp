        ...
        <div class="col-md-10 main">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    %>
                    <tr>
                        <td><%=fightOrderVO.getOrderNo()%>
                        </td>
                        <td><%=fightOrderVO.getFightNo()%>
                        </td>
                        <td><%=fightOrderVO.getStatrdate()%>
                        </td>
                    </tr>
                    <tr>
                        <th>起始地</th>
                    ...
                    %>
                    <tr>
                        <td><%=detatilVO.getDeparture()%>
                        </td>
                        <td><%=detatilVO.getDepartureTime()%>
                        </td>
                        <td><%=detatilVO.getDestination()%>
                        </td>
                        <td><%=detatilVO.getDestinationTime()%>
                        </td>
                        <td><%=detatilVO.getFightCompany()%>
                        </td>
                        <td><%=detatilVO.getFightType()%>
                        </td>
                        <td><%=detatilVO.getFightPay()%>
                        </td>
                        <td><%=detatilVO.getUserName()%>
                        </td>
